...
console.log ('Kliendi nimi on ' + tellimus.clientName)
console.log ('Tellimuse number on ' + tellimus.orderNumber)
let o = 0
let c = ''
let k = 0
for (let i=0;i < tellimus.rows.length;i+=1){
    o += (tellimus.rows[i]['price']*tellimus.rows[i]['amount']);
    c += (tellimus.rows[i]['name'] + ' \n')
}
console.log ('Tellimus maksis kokku ' + o + ' €')
console.log ('Sellest '+ o*0.2 +'€ on käibemaks')
console.log ('Ta ostis ' + c)
